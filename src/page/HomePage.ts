  ...
  <header class="bg-gray-50 relative">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="max-w-2xl mx-auto text-center py-32">
        <h1 class="text-4xl sm:text-6xl tracking-tight font-display font-medium text-gray-900">LZ2LAM</h1>
      ...
      <div class="grid grid-cols-3 gap-6 pb-16">
        <div class="flex gap-6">
          ...
          <div>
            <p class="text-sm font-semibold leading-6 text-gray-900">Quansheng UV-K5(8)</p>
            <p class="mt-2 text-sm leading-6 text-gray-700">Portable · Analog · 5W · VHF/UHF</p>
          </div>
        </div>
        <div class="flex gap-6">
          <div class="w-10 h-10 bg-blue-50 shrink-0 ring-2 ring-blue-500 text-blue-500 ring-inset rounded-lg shadow-md shadow-blue-500/[.12] flex items-center justify-center" aria-hidden="true">
          ...
          <div>
            <p class="text-sm font-semibold leading-6 text-gray-900">Quansheng UV-K5(99)</p>
            <p class="mt-2 text-sm leading-6 text-gray-700">Portable · Analog · 5W · VHF/UHF</p>
          </div>
        </div>
        <div class="flex gap-6">
